...
def read_row(data_path):
    with open(data_path, 'r', encoding='utf-8') as f:
        ...
        for line in f:
            ...
            yield {'question': word1, 'answer': word2, 'antmorph': antmorph, 'labels':gold}
...
def do_train(args):
    ...
    train_ds = paddlenlp.datasets.dataset.load_dataset(read_row, data_path=dir + 'tag-' + args.pos + '-pairs.train.csv', lazy=False)
    dev_ds = paddlenlp.datasets.dataset.load_dataset(read_row, data_path=dir + 'tag-' + args.pos + '-pairs.val.csv', lazy=False)
    test_ds = paddlenlp.datasets.dataset.load_dataset(read_row, data_path=dir + 'tag-' + args.pos + '-pairs.test.csv', lazy=False)
